...
import { DragRef } from './drag-drop/drag-ref';
import { CdkDrag } from './drag.directive';
import {CdkDragDrop, CdkDragEnter, CdkDragExit, CdkDragSortEvent} from '../app/drag-drop/drag-events';
...
import {DropListRef} from '../app/drag-drop/drop-list-ref';
import {Directionality} from '@angular/cdk/bidi';
import {ScrollDispatcher} from '@angular/cdk/scrolling';


import {CDK_DROP_LIST_GROUP, CdkDropListGroup} from './drop-list-group.directive';
...
@Output('cdkDropListExited')
 ...
 getSortedItems(): CdkDrag[] {
  ...
  //ssigns the default input values based on a provided config object. 
